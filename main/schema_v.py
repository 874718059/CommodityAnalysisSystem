...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        # cmd = "cd /yykj/python/9999/spidero2l3x9ar && scrapy crawl "+tableName+"Spider -a databaseName=django34eeh4af"
        # Windows
        cmd = "cd D:\\BYSJ\\spider && D:\\DevSoft\\Python\\Python37\\Scripts\\scrapy.exe crawl " + tableName + "Spider -a databaseName=django34eeh4af"
        os.system(cmd)
