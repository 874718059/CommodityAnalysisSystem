...
<div class="content" :style='{"minHeight":"100vh","padding":"20px 30px 20px","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230929/29af140d1a664450a9890decb66d8af8.png) no-repeat center top / cover","display":"flex","fontSize":"14px","height":"auto"}'>
	...
	<div :style='{"border":"0px solid rgba(126, 96, 16, .1)","padding":"0px 0","margin":"0 30px 20px 0px","alignItems":"center","color":"#1e3c4f","flexWrap":"wrap","background":"none","display":"flex","width":"400px","fontSize":"14px","justifyContent":"center","order":"0"}'>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"12px 0","margin":"0 0 20px 0","borderColor":"rgba(126, 96, 16, .1)","borderRadius":"8px","alignItems":"center","textAlign":"left","background":"#fff","borderWidth":"0 0 0px","display":"flex","width":"100%","borderStyle":"solid"}' v-if="isAuth('shangpinxinxi','首页总数')">
			...
			<div :style='{"width":"auto","flexDirection":"column-reverse","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"34px","color":"inherit","fontWeight":"bold","height":"24px"}'>{{shangpinxinxiCount}}</div>
	...
	<div class="type5" :style='{"alignContent":"flex-start","padding":"0","borderRadius":"8px","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto","order":"3"}'>
		<div id="shangpinxinxiChart1" class="echarts1" v-if="isAuth('shangpinxinxi','首页统计')"></div>
		<div id="shangpinxinxiChart2" class="echarts2" v-if="isAuth('shangpinxinxi','首页统计')"></div>
		<div id="shangpinxinxiChart3" class="echarts3" v-if="isAuth('shangpinxinxi','首页统计')"></div>
		<div id="shangpinxinxiChart4" class="echarts4" v-if="isAuth('shangpinxinxi','首页统计')"></div>
		<div id="shangpinxinxiChart5" class="echarts5" v-if="isAuth('shangpinxinxi','首页统计')"></div>
	</div>
</div>
</template>
<script>
