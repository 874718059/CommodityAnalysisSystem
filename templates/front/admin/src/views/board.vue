			...
			<div :style='{"width":"30%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				...
				<div class="echarts2">
					...
					<div :style='{"width":"100%","height":"85%"}'>
						<div id="shangpinxinxiChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
				...
				<div :style='{"alignContent":"center","padding":"0","margin":"0 0 20px 0","color":"#fff","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","height":"100px","order":"1"}'>
					...
					<div :style='{"margin":"0 10px 0 0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231223/9c1f0d184ede4dee8925bb6c57ba14b7.png) no-repeat center top / 100% 100%","flexDirection":"column","flex":"1","display":"flex","width":"calc(20% - 10px)","justifyContent":"center","height":"100%"}'>
						...
						<div :style='{"padding":"0 0px","alignItems":"center","flexDirection":"column-reverse","display":"flex"}'>
							...
							<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{shangpinxinxiCount}}</div>
						</div>
					</div>
				</div>
				<div class="tables">
					<div :style='{"margin":"0 0 20px 0","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","width":"100%","fontSize":"16px","height":"42px"}'>商品信息</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"rgba(92,135,230,.3)","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
						...
						<el-table-column :resizable="true" :sortable="false" prop="pingjunfen" label="平均分"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="haopingdu" label="好评度"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="zhongpingdu" label="中评度"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="chapingdu" label="差评度"/>
						</el-table-column>
					</el-table>
				</div>
			</div>
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, shangpinxinxiChart2)
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(2, option.yAxis.data, option.series[0].data, shangpinxinxiChart4)
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, shangpinxinxiChart5)
